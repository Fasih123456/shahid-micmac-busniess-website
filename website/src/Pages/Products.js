...
import img from "../assets/products-page-img.jpg";
...
function Products() {
	return (
		<React.Fragment>
			<Header display={true} Route={"Scope Of Products"} image={img} />
			<main id="main">
				<section style={{ marginLeft: "5%" }}>
					...
					>
						...
						<li>
							{" "}
							Manual Valves (Gate, Globe Check & Butterfly Valve)
						</li>
					...
					>
						...
						<li>
							{" "}
							Actuators- Electric, Pneumatic & Electrohydraulic
						</li>
