...
//Sector images
import image1 from "../assets/sectorsimg/oilgas.jpg";
...
import image6 from "../assets/sectorsimg/industries.jpg";
import image7 from "../assets/sectorsimg/infrastructure.jpg";
            ...
            <div class="row gy-4 portfolio-container">
              ...
              >
                <div class="portfolio-content h-100">
                  ...
                  <div class="portfolio-info">
                    <p>Oil & Gas</p>
                    <a href={image1} title="Remodeling 1" class="glightbox preview-link"  style={{ height: "30vh" }}  >
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-construction">
                <div class="portfolio-content h-100">
                  ...
                  <div class="portfolio-info">
                    <p>Power</p>
                    <a href={image2} title="Construction 1" class="glightbox preview-link"  style={{ height: "30vh" }}  >
                      <i class="bi bi-zoom-in"></i>
                    </a>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                <div class="portfolio-content h-100">
                  ...
                  <div class="portfolio-info">
                    <p>Refining</p>
                    <a href={image3} title="Repairs 1" class="glightbox preview-link"  style={{ height: "30vh" }}  >
                      <i class="bi bi-zoom-in"></i>
                    </a>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-design">
                <div class="portfolio-content h-100">
                  ...
                  <div class="portfolio-info">
                    <p>Petrochemicals</p>
                    <a href={image4} title="Repairs 1" class="glightbox preview-link"  style={{ height: "30vh" }}  >
                      <i class="bi bi-zoom-in"></i>
                    </a>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-remodeling">
                <div class="portfolio-content h-100">
                  ...
                  <div class="portfolio-info">
                    <p>Marine</p>
                    <a href={image5} title="Remodeling 2" class="glightbox preview-link"  style={{ height: "30vh" }}  >
                      <i class="bi bi-zoom-in"></i>
                    </a>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-construction">
                <div class="portfolio-content h-100">
                  ...
                  <div class="portfolio-info">
                    ...
                    <a href={image6} title="Construction 2" class="glightbox preview-link"  style={{ height: "30vh" }}  >
                      <i class="bi bi-zoom-in"></i>
                    </a>
              ...
              <div class="col-lg-4 col-md-6 portfolio-item filter-repairs">
                <div class="portfolio-content h-100">
                  ...
                  <div class="portfolio-info">
                    ...
                    <a href={image7} title="Repairs 2" class="glightbox preview-link"  style={{ height: "30vh" }}  >
                      <i class="bi bi-zoom-in"></i>
                    </a>
